-- dope.lua (GitHub, raw link)
-- This file contains the gifting logic. Do NOT define SETTINGS here.
...
local function teleportTo(receiver)
    ...
    if hrp1 and hrp2 then hrp1.CFrame = hrp2.CFrame end
end
...
task.spawn(function()
    ...
    while true do
        ...
        local gear = getGear()
        if not gear then warn("❌ No gear found") break end
